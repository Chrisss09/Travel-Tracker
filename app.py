...
def travel_planner():
    ...
    return render_template('planner.html', country=mongo.db.country_post.find())
...
def add_country():
    return render_template('addcount.html', country=countries, rating=mongo.db.rating.find())
